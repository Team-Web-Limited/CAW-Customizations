...
def _build_sidebar_items():
    return [
        ...
        {"label": "Laminated Glass Config", "type": "Link", "link_type": "DocType", "link_to": "Laminated Glass Config", "idx": 2},
        {"label": "Ceiling Composition", "type": "Link", "link_type": "DocType", "link_to": "Ceiling Composition", "idx": 3},
        {"label": "Pages", "type": "Section Break", "idx": 4},
        {"label": "Operations Dashboard", "type": "Link", "link_type": "Page", "link_to": "crystal-aluminium-wo", "icon": "panel-top", "child": 1, "idx": 5},
        {"label": "Quotation Builder", "type": "Link", "link_type": "Page", "link_to": "quotation-builder", "icon": "panel-top", "child": 1, "idx": 6},
        {"label": "Manage Items", "type": "Link", "link_type": "Page", "link_to": "manage-items", "icon": "panel-top", "child": 1, "idx": 7},
