...
function load_single_job_card_detail(page, job_card_name) {
	...
	frappe.call({
		...
		callback: function(r) {
			...
			$body.html(render_single_job_card_detail(message.job_card, message.quotation));
			bind_single_job_card_detail_events($body, message.job_card);
		}
	});
}
...
function bind_single_job_card_detail_events($body, job_card) {
...
function render_single_job_card_detail(job_card, quotation) {
